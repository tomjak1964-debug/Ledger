...
export default function MachineRatesView({ db, actions, toast, readOnly }) {
  ...
  return <div>
    <div className="toolbar">
      ...
      {!readOnly && <button className="btn primary" style={{ marginLeft: "auto" }} onClick={() => setEdit({ id: uid(), _new: true, name: "", sort: db.machineTypes.length, ...Object.fromEntries(RATE_FIELDS.map(([k]) => [k, 0])) })}><Ico d={ICONS.plus} size={15} />New Machine Type</button>}
    </div>
    <div className="card">
